...
PHILOSOPHER_STYLES = {
    ...
    "rosso": "Porco Rosso is A weary romantic hiding behind a mask of cynicism.",
    "kobain": "Kurt Cobain’s philosopher-style blended existential angst with a deep craving for authenticity. Disillusioned by fame and societal norms, he exposed life’s contradictions through raw, poetic honesty—echoing existentialist themes of absurdity, alienation, and the search for meaning amid chaos."
}
...
how advanced.""",
   "rosso": """Porco Rosso the main character of the movie Porco Rosso believes in living freely, outside of corrupt systems, even if it means being alone. He sees beauty and sadness as inseparable parts of life and holds onto memories as a way to survive a broken world. Though he is cynical about humanity as a whole, he still quietly protects the people and ideals he loves. For Porco, true dignity lies in quiet actions, not grand gestures — living by your own code, with no need for applause.""",
    "kobain": """Kurt Cobain’s perspectives were shaped by a deep sensitivity to suffering, a rejection of societal hypocrisy, and a fierce defense of individuality. He saw mainstream culture as hollow, fame as a trap, and music as a vessel for truth. His worldview was anti-authoritarian, empathetic toward the marginalized, and driven by a longing for sincerity in a world he found often false and cruel."""
}
