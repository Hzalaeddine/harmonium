...
export class Preloader extends Scene
{
    ...
    preload ()
    {
        ...
        this.load.atlas("rosso", "characters/rosso/atlas.png", "characters/rosso/atlas.json"); 
        this.load.atlas("kobain", "characters/kobain/atlas.png", "characters/kobain/atlas.json"); 
    }
